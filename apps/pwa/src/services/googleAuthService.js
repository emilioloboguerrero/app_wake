    ...
    if (isWeb) {
      try {
        ...
        if (error.code === 'auth/account-exists-with-different-credential') {
          // The email already has an account (created via code/email). Don't
          // spawn a duplicate — route the user to their existing account via a
          // login code. One human, one account.
          return {
            success: false,
            needsCode: true,

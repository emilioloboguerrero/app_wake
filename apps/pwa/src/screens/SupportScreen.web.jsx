...
const FAQS = [
  {
    ...
    answer: `La vía más rápida es WhatsApp al ${SUPPORT_WHATSAPP_DISPLAY}: te respondemos directo desde el chat. También puedes escribirnos por correo a ${SUPPORT_EMAIL}, donde respondemos en 24-48 horas durante días hábiles.`,
  },
  {

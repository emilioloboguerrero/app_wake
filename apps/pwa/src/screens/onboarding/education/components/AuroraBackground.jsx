...
export default function AuroraBackground({ step = 0 }) {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Subtle intensity shift per step
      const s = stepRef.current;
      const intensity = s === 1 ? 1.35 : s === 2 ? 1.2 : 1;
      ...
      blobs.forEach((blob) => {
        ...
        gradient.addColorStop(0, `rgba(${cr}, ${cg}, ${cb}, ${0.06 * intensity})`);
        gradient.addColorStop(0.5, `rgba(${cr}, ${cg}, ${cb}, ${0.02 * intensity})`);

...
const createStyles = (screenWidth, screenHeight, insets = { top: 0 }) => StyleSheet.create({
  ...
  setInputModalNotesCard: {
    marginTop: Math.max(20, screenHeight * 0.025),
    paddingTop: Math.max(16, screenHeight * 0.02),
    borderTopWidth: 1,
    borderTopColor: 'rgba(255, 255, 255, 0.1)',
  },
  setInputModalNotesTitle: {
    fontSize: Math.min(screenWidth * 0.04, 16),
    fontWeight: '600',
    color: '#ffffff',
    marginBottom: 10,
  },
  setInputModalNotesInput: {
  ...
  notesBottomSheet: {
    ...
    paddingHorizontal: Math.max(20, screenWidth * 0.05),
    paddingTop: Math.max(16, screenHeight * 0.02),
    paddingBottom: Math.max(24, screenHeight * 0.03) + 40,
  },
  ...
  notesBottomSheetTitle: {
    fontSize: Math.min(screenWidth * 0.05, 20),
    fontWeight: '600',
    color: '#ffffff',
  },
  notesBottomSheetClose: {
    padding: 8,
    margin: -8,
  },
  notesBottomSheetCloseText: {
    color: 'rgba(255, 255, 255, 0.8)',
    fontSize: 20,
  },
  notesBottomSheetInput: {
    backgroundColor: 'rgba(255, 255, 255, 0.08)',
    borderRadius: Math.max(12, screenWidth * 0.03),
  ...
  // Notas y videos — unified sheet content
  nvSheetScroll: {
    maxHeight: Math.min(screenHeight * 0.6, 520),
    marginBottom: 16,
  },
  nvSheetScrollContent: {
    paddingBottom: 8,
  },
  nvSectionLabel: {
    fontSize: 11,
  ...
  // Register modal — video submit row
  setInputVideoButton: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
  ...
  setInputVideoSubtitle: {
    marginTop: 2,
    color: 'rgba(255,255,255,0.55)',
    fontSize: 12,
  },
  setInputVideoChevron: {
    color: 'rgba(255,255,255,0.4)',
    fontSize: 22,
    fontWeight: '300',
    marginLeft: 6,
  },
  notesBottomSheetButton: {
    backgroundColor: 'transparent',
    borderRadius: 999,
    borderWidth: 1.5,
    borderColor: 'rgba(255, 255, 255, 0.6)',
  ...
  sessionNotesCardDisabled: {
    opacity: 0.5,
  },
  sessionNotesCardTitle: {
    fontSize: Math.min(screenWidth * 0.04, 16),
    fontWeight: '600',
    color: 'rgba(255, 255, 255, 0.9)',
    marginBottom: 6,
  },
  sessionNotesCardPreview: {
    fontSize: Math.min(screenWidth * 0.035, 14),
    color: 'rgba(255, 255, 255, 0.6)',
    lineHeight: 20,
  },

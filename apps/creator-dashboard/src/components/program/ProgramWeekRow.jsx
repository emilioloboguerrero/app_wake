...
export default function ProgramWeekRow({ module, moduleIndex, isIncomplete, onClick, style }) {
  ...
  return (
    <div
      ...
      style={{
        animation: `enterUp 0.42s cubic-bezier(0.22,1,0.36,1) ${moduleIndex * 0.06}s both`,
        ...style,
      }}
    >

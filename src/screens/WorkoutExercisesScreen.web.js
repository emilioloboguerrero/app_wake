// Web wrapper for WorkoutExercisesScreen - provides React Router navigation
...
const WorkoutExercisesScreenModule = require('./WorkoutExercisesScreen.js');
const WorkoutExercisesScreenBase = WorkoutExercisesScreenModule.default;
...
const WorkoutExercisesScreen = () => {
  ...
  const navigation = {
    navigate: (routeName, params) => {
      logger.log('🧭 [WorkoutExercises Web] Navigating to:', routeName, params);
    ...
    goBack: () => navigate(-1),
    setParams: (params) => {
      logger.log('🧭 [WorkoutExercises Web] setParams:', params);
    },
  };
  ...
  return <WorkoutExercisesScreenBase navigation={navigation} route={route} />;
};

...
const SvgBodyPartMuscleStrokeRounded = (props) => {
  const { stroke = "#fff", strokeWidth = 1.5, width = 24, height = 24, ...svgProps } = props;
  return (
    <Svg
...
export default SvgBodyPartMuscleStrokeRounded;
